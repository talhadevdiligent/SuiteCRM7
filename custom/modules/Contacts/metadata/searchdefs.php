    ...
    'layout' => array(
        ...
        'advanced_search' =>
            array(
                ...
                'LBL_BACKGROUND_INFORMATION' =>
                    array(
                        'name' => 'background_information',
                        'label' => 'LBL_BACKGROUND_INFORMATION',
                        'width' => '10%',
                    ),
                'LBL_CONSENT_DATA_SHARING' =>
                    array(
                        'name' => 'consent_data_sharing',
                        'label' => 'LBL_CONSENT_DATA_SHARING',
                        'width' => '10%',
                    ), 
                'LBL_COUNTRY' =>
                    array(
                ...
                'LBL_DATE_ADDED' =>
                    array(
                        'name' => 'date_added',
                        'label' => 'LBL_DATE_ADDED',
                        'width' => '10%',
                    ), 
                'LBL_EMERGENCY_PHONE_NUMBER' =>
                    array(
                        'name' => 'emergency_phone_number',
                        'label' => 'LBL_EMERGENCY_PHONE_NUMBER',
                        'width' => '10%',
                    ), 
                'LBL_LANGUAGES' =>
                    array(
